...
function GoogleLoginButton () {
    ...
    return (
        <button className="btn btn-lg w-100 bg-white text-black d-flex align-items-center justify-content-center gap-2" onClick={handleGoogleLogin}>
